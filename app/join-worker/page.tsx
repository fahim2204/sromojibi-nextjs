...
export default function JoinWorkerPage() {
  ...
  const serviceCategories = [
    ...
    { key: "Other", label: "🛠️ Other Skilled Trades (অন্যান্য কারিগরি পেশা)" },
  ];

  const experienceLevels = [
    { key: "1", label: "১ বছর (1 Year / নবাগত)" },
    { key: "2", label: "২ বছর (2 Years)" },
    { key: "3", label: "৩ বছর (3 Years)" },
    { key: "4", label: "৪ বছর (4 Years)" },
    { key: "5", label: "৫ বছর (5 Years)" },
    { key: "7", label: "৭ বছর (৬-৮ বছর / অভিজ্ঞ)" },
    { key: "10", label: "১০ বছর (৮-১০ বছর / সিনিয়র)" },
    { key: "12", label: "১২ বছর (১০-১৫ বছর / সিনিয়র মিস্ত্রি)" },
    { key: "15", label: "১৫+ বছর (হেড মিস্ত্রি / মাস্টার)" },
  ];
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 py-6 sm:py-12 px-3 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        {/* Hero Header */}
        <div className="text-center space-y-3 sm:space-y-4 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider shadow-2xs">
            <Zap className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
            <span>ফ্রি মিস্ত্রি নিবন্ধন • Worker Registration</span>
          </div>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
            আপনি কি দক্ষ মিস্ত্রি বা কারিগর?
          </h1>
          <p className="text-slate-600 text-xs sm:text-sm md:text-base leading-relaxed px-1">
        ...
        {/* Top Benefits Bar */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 bg-white p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-200 shadow-2xs">
          <div className="flex items-center gap-2 sm:gap-2.5 p-1">
            ...
            <div className="min-w-0">
              <div className="font-bold text-[11px] sm:text-xs text-slate-900 truncate">১০০% ফ্রি</div>
              <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">কোনো হিডেন ফি নেই</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 p-1">
            ...
            <div className="min-w-0">
              <div className="font-bold text-[11px] sm:text-xs text-slate-900 truncate">সরাসরি কল</div>
              <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">কাস্টমার ডিরেক্ট কল করবে</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 p-1">
            ...
            <div className="min-w-0">
              <div className="font-bold text-[11px] sm:text-xs text-slate-900 truncate">লোকাল কভারেজ</div>
              <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">ওয়ার্ড/ইউনিয়ন অ্যাড্রেস</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 p-1">
            ...
            <div className="min-w-0">
              <div className="font-bold text-[11px] sm:text-xs text-slate-900 truncate">অনলাইন প্রোফাইল</div>
              <div className="text-[9px] sm:text-[10px] text-slate-400 truncate">গুগল সার্চে আসার সুবিধা</div>
            </div>
          </div>
        </div>

        {/* Full-width Form Card */}
        <Card className="border border-slate-200/80 shadow-xs bg-white rounded-2xl sm:rounded-3xl w-full">
          <CardBody className="p-4 sm:p-8 md:p-10 space-y-6 sm:space-y-8">
            {submitted ? (
              <div className="py-8 sm:py-12 text-center space-y-4 sm:space-y-5">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mx-auto text-2xl sm:text-3xl">
                  🎉
                </div>
                <div className="space-y-2 px-1">
                  <h2 className="text-xl sm:text-2xl font-black text-slate-900">রেজিস্ট্রেশন সফল হয়েছে!</h2>
                ...
                <div className="pt-2 sm:pt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 sm:gap-3 max-w-xs sm:max-w-none mx-auto">
                  <Button
                    onPress={() => {
                      setSubmitted(false);
                    ...
                    className="bg-slate-900 text-white font-bold text-xs rounded-xl px-6 h-11"
                  >
                  ...
                  <Button
                    ...
                    href="/locations"
                    variant="flat"
                    className="bg-slate-100 text-slate-700 font-bold text-xs rounded-xl px-6 h-11"
                  >
                    ডিরেক্টরি দেখুন
                  </Button>
                </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                {/* Auth Gate Header */}
                <div className="text-center space-y-2.5 sm:space-y-3 max-w-xl mx-auto px-1">
                ...
                <div className="max-w-md mx-auto bg-slate-50/80 border border-slate-200 rounded-xl sm:rounded-2xl p-4 sm:p-7 space-y-3.5 sm:space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      <Button
                        ...
                        variant="bordered"
                        className="w-full bg-white border border-slate-300 hover:border-slate-400 hover:bg-slate-100 text-slate-800 font-bold text-xs rounded-xl h-11 sm:h-10 transition-colors"
                      >
                        লগইন করুন (Sign In)
                      </Button>
                      <Button
                        ...
                        className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl h-11 sm:h-10 transition-colors"
                      >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-1 sm:pt-2">
                  <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-200 bg-white space-y-2">
                ...
                <div className="p-3.5 sm:p-5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 sm:gap-2">
                    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700">
                      মিস্ত্রি নিবন্ধনের ৩টি সহজ ধাপ (How Worker Registration Works)
                    </h3>
                    <span className="self-start sm:self-auto text-[10px] font-semibold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200">
                      সময় লাগবে: ২ মিনিট
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 sm:gap-3 text-xs">
                    ...
                    <div className="bg-white p-3 rounded-xl border border-slate-200 space-y-1">
                      <div className="font-bold text-slate-800 flex items-center gap-1.5">
                        ...
                        কাজের পেশা ও অভিজ্ঞতা
                      </div>
                      <p className="text-slate-500 text-[11px] leading-relaxed">
                        ইলেকট্রিশিয়ান, প্লাম্বার, রাজমিস্ত্রি সহ কাজের পেশা ও অভিজ্ঞতার বছর নির্বাচন করুন।
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                ...
                <div className="p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-emerald-50/80 border border-emerald-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
                ...
                <div className="border-b border-slate-100 pb-3 sm:pb-4">
                  <h2 className="text-lg sm:text-xl font-extrabold text-slate-900">ফ্রি প্রোফাইল তথ্য পূরণ করুন</h2>
                  <p className="text-xs text-slate-400 mt-0.5">
                    সঠিক মোবাইল নম্বর এবং ইউনিয়ন পর্যন্ত ঠিকানা প্রদান করুন।
                  </p>
                </div>

                {/* Step 1: Personal & Contact Details */}
                <div className="space-y-5 sm:space-y-6">
                  <div className="flex items-start sm:items-center gap-2 pb-3 border-b border-slate-200">
                    <span className="w-6 h-6 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs font-bold shadow-2xs shrink-0 mt-0.5 sm:mt-0">
                      ১
                    </span>
                    <div>
                      <h3 className="text-xs sm:text-sm font-bold text-slate-900">
                        ব্যক্তিগত তথ্য ও কাজের পেশা (Personal & Trade Info)
                      </h3>
                      <p className="text-[10px] sm:text-[11px] text-slate-500 font-medium">
                        আপনার নাম, সচল মোবাইল নম্বর এবং আপনি কী কাজ করেন তা নির্বাচন করুন
                      </p>
                    </div>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-7 gap-x-6">
                    <div className="sm:col-span-2">
                      <Input
                        ...
                        classNames={{
                          label: "text-slate-700 font-semibold text-xs mb-2",
                    ...
                    <div>
                      <Input
                        labelPlacement="outside"
                        type="tel"
                        label="Secondary Phone / বিকল্প নম্বর (ঐচ্ছিক)"
                    ...
                    <div className="sm:col-span-2">
                      <Select
                        ...
                        aria-label="কাজের পেশা / আপনি কী কাজ করেন?"
                        labelPlacement="outside"
                        label={`কাজের পেশা / আপনি কী কাজ করেন? (সর্বোচ্চ ৩টি নির্বাচন করুন - ${selectedTrades.length}/3)`}
                        placeholder="পেশা নির্বাচন করুন (যেমন: ইলেকট্রিশিয়ান, প্লাম্বার, রাজমিস্ত্রি...)"
                        variant="bordered"
                        ...
                        classNames={{
                          label: "text-slate-700 font-semibold text-xs mb-2 text-left text-start block w-full",
                          ...
                          popoverContent: "bg-white border border-slate-200 text-slate-900 shadow-xl z-50 max-w-[calc(100vw-2.5rem)] sm:max-w-none",
                        }}
                        renderValue={(items) => (
                    ...
                    <div className="sm:col-span-2">
                      <Select
                        ...
                        labelPlacement="outside"
                        label="কাজের অভিজ্ঞতা (Experience)"
                        placeholder="আপনার কাজের অভিজ্ঞতার বছর নির্বাচন করুন"
                        variant="bordered"
                        ...
                        classNames={{
                          label: "text-slate-700 font-semibold text-xs mb-2 text-left text-start block w-full",
                          value: "text-slate-900 text-xs sm:text-sm",
                          ...
                          popoverContent: "bg-white border border-slate-200 text-slate-900 shadow-xl z-50 max-h-60 max-w-[calc(100vw-2.5rem)] sm:max-w-none",
                        }}
                      >
                ...
                <div className="space-y-5 sm:space-y-6 pt-4 sm:pt-6">
                  ...
                  <div className="flex items-start sm:items-center gap-2 pb-3 border-b border-slate-200">
                    ...
                    <div>
                      <h3 className="text-xs sm:text-sm font-bold text-slate-900 flex flex-wrap items-center gap-1.5 sm:gap-2">
                        <span>ঠিকানা ও কর্মক্ষেত্র নির্বাচন (Location & Coverage)</span>
                        <span className="text-[10px] sm:text-[11px] font-semibold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200">
                          {addressType === "urban" ? "🏙️ মেট্রো এলাকা" : "🌾 উপজেলা পরিষদ"}
                        </span>
                      </h3>
                      <p className="text-[10px] sm:text-[11px] text-slate-500 font-medium">
                        {addressType === "urban"
                          ? "বিভাগ ➔ জেলা ➔ মেট্রো থানা ➔ শহরের প্রধান এলাকা"
                          : "বিভাগ ➔ জেলা ➔ উপজেলা ➔ ইউনিয়ন পরিষদ"}
                      </p>
                    </div>
                  </div>

                  {/* Level 1, 2, 3, 4 Cascading Dropdowns in a Unified Grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-7 gap-x-6">
                    <div>
                      <Select
                        isRequired
                    ...
                    <div className={isCityThana ? "sm:col-span-2" : ""}>
                      <Select
                        isRequired
                        isMultiline
                        disableAnimation
                        ...
                        classNames={{
                          ...
                          value: "text-slate-900 text-xs sm:text-sm",
                          trigger: "border-slate-200 hover:border-emerald-500 focus-within:!border-emerald-500 bg-slate-50/50 rounded-xl shadow-2xs cursor-pointer h-11",
                          popoverContent: "bg-white border border-slate-200 text-slate-900 shadow-xl z-50 max-h-72 max-w-[calc(100vw-2.5rem)] sm:max-w-none",
                        }}
                      >
                        <SelectSection
                          title="🌐 কর্মক্ষেত্রের আওতা (Large Coverage Scope)"
                          classNames={{
                            heading: "text-[10px] sm:text-[11px] font-bold text-emerald-800 uppercase bg-emerald-50/80 px-2 py-1 rounded",
                          }}
                        >
                          <SelectItem
                        ...
                        {categorizedUpazilas.hasCityCorp && categorizedUpazilas.upazilaItems.length > 0 ? (
                          <SelectSection
                            ...
                            classNames={{
                              heading: "text-[10px] sm:text-[11px] font-bold text-slate-600 uppercase bg-slate-100 px-2 py-1 rounded",
                            }}
                          >
                  ...
                  {(formData.city || formData.zilla || formData.upazila) && (
                    <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-emerald-50/70 border border-emerald-200/80 text-xs text-emerald-900 space-y-2 mt-3">
                      <div className="font-bold flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2">
                        <div className="flex items-center gap-1.5 text-emerald-800">
                          <MapPin className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
                          <span>নির্বাচিত কর্মক্ষেত্র:</span>
                        </div>
                        <span className="self-start sm:self-auto text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200">
                      ...
                      <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 font-medium pt-0.5">
                ...
                <div className="space-y-5 sm:space-y-6 pt-4 sm:pt-6">
                  <div className="flex items-start sm:items-center gap-2 pb-3 border-b border-slate-200">
                    <span className="w-6 h-6 rounded-full bg-slate-800 text-white flex items-center justify-center text-xs font-bold shadow-2xs shrink-0 mt-0.5 sm:mt-0">
                      ৩
                    </span>
                    <div>
                      <h3 className="text-xs sm:text-sm font-bold text-slate-900">
                        অতিরিক্ত বিবরণ ও ইমেইল (Optional Details)
                      </h3>
                      <p className="text-[10px] sm:text-[11px] text-slate-500 font-medium">
                        আপনার কাজের বিশেষ দক্ষতা ও যোগাযোগের বিকল্প তথ্য (ঐচ্ছিক)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-y-6 sm:gap-y-7">
                    <div>
                      <Input
                        labelPlacement="outside"
                        type="email"
                        label="Email Address / ইমেইল (ঐচ্ছিক)"
                    ...
                    <div>
                      <Textarea
                        labelPlacement="outside"
                        label="Specialty / কাজের বিশেষ দক্ষতার বিবরণ (ঐচ্ছিক)"
                ...
                <div className="pt-2">
                  <Button
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm shadow-xs rounded-xl transition-colors h-11 sm:h-12 cursor-pointer active:scale-98"
