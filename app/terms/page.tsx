    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 py-16 px-4">
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="space-y-3 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900">Terms of Service</h1>
        ...
        <div className="space-y-8 text-gray-700">
          <section className="space-y-3">
            <h2 className="text-2xl font-bold text-gray-900">1. Platform Nature (Open Directory)</h2>
            ...
            <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs sm:text-sm font-medium">
          ...
          <section className="space-y-3 pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">2. Direct Connection & Independent Contracting</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-3 pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">3. Disclaimer of Warranties & Dispute Liability</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-3 pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">4. Worker Conduct & Free Profile Guidelines</h2>
            <p className="text-base leading-relaxed">
