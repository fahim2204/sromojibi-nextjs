    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 py-16 px-4">
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="space-y-3 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900">About Sromojibi</h1>
        ...
        <div className="space-y-8 text-gray-700">
          <section className="space-y-3">
            <h2 className="text-2xl font-bold text-gray-900">Building Bangladesh&apos;s Worker Directory</h2>
          ...
          <section className="space-y-4 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                <h3 className="font-bold text-emerald-700 text-base mb-1">🔍 Open Discovery</h3>
                <p className="text-xs text-gray-600">
                  Making worker profiles indexed, searchable, and easily reachable for local households.
                </p>
              </div>
              <div className="p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                <h3 className="font-bold text-emerald-700 text-base mb-1">🆓 Free Worker Profiles</h3>
                <p className="text-xs text-gray-600">
                  Worker listings will be free during our initial launch period to maximize opportunity for all skilled mistris.
                </p>
              </div>
              <div className="p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                <h3 className="font-bold text-emerald-700 text-base mb-1">📍 Local Focus</h3>
                <p className="text-xs text-gray-600">
                  Organized by division, city, and trade category for maximum relevance and fast contact.
                </p>
              </div>
              <div className="p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                <h3 className="font-bold text-emerald-700 text-base mb-1">🛡️ Directory Model</h3>
                <p className="text-xs text-gray-600">
          ...
          <section className="space-y-4 pt-6 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">Are You a Skilled Professional?</h2>
            <p className="text-base leading-relaxed">
