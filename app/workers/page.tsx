      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between border-b border-gray-200 pb-3">
            <h2 className="text-2xl font-bold text-gray-900">Browse by Worker Category</h2>
            <Link href="/categories" className="text-xs font-semibold text-emerald-600 hover:underline">
              All Categories →
            </Link>
          </div>
        ...
        {/* Worker CTA Banner */}
        <div className="p-8 rounded-3xl bg-gradient-to-r from-emerald-50 via-teal-50 to-emerald-50 border border-emerald-200 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
          <div className="space-y-2">
            <h3 className="text-2xl font-bold text-gray-900">Are you a skilled worker?</h3>
          ...
          <Link
            href="/join-worker"
            className="px-6 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shrink-0 transition-all shadow-md"
          >
