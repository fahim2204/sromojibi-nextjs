...
export default function Footer() {
  return (
    <footer className="bg-white text-gray-600 text-sm border-t border-gray-200 pt-12 pb-8">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div className="space-y-3">
          <div className="flex items-center gap-2 text-gray-900 font-extrabold text-xl">
            ...
            />
            <span className={`${brandFont.className} bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent font-black tracking-tight text-xl`}>
              Sromojibi
            </span>
          </div>
        ...
        <div>
          <h3 className="text-gray-900 font-semibold mb-3 text-sm">Quick Links</h3>
          <ul className="space-y-2 text-xs">
            <li>
      ...
      <div className="max-w-6xl mx-auto px-4 border-t border-gray-200 pt-6 text-center text-xs text-gray-500">
